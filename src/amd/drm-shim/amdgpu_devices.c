...
const struct amdgpu_device amdgpu_devices[] = {
   ...
   },
   {
      ...
      .dev = {
         ...
         .max_engine_clock = 1630000llu,
         .max_memory_clock = 945000llu,
         .cu_active_number = 64,
      ...
      .mem = {
         .vram = {
            .total_heap_size = 8573157376,
            .usable_heap_size = 8556453888,
            .heap_usage = 39575552,
            .max_allocation = 6417340416,
         },
         .cpu_accessible_vram = {
            .total_heap_size = 268435456,
            .usable_heap_size = 260120576,
            .heap_usage = 30138368,
            .max_allocation = 195090432,
         },
         .gtt = {
            .total_heap_size = 8359135232,
            .usable_heap_size = 8346802176,
            .heap_usage = 22892544,
            .max_allocation = 6260101632,
         },
      },
   },
   {
      ...
      .dev = {
         ...
         .gpu_counter_freq = 100000,
         .max_engine_clock = 2100000llu,
         .max_memory_clock = 875000llu,
         .cu_active_number = 40,
         .cu_ao_mask = 0xffffffff,
         .cu_bitmap = {
            { 0x3ff, 0x3ff, 0x0, 0x0, },
      ...
      .mem = {
         .vram = {
            .total_heap_size = 8573157376,
            .usable_heap_size = 8553127936,
            .heap_usage = 11644928,
            .max_allocation = 6414845952,
         },
         .cpu_accessible_vram = {
            .total_heap_size = 268435456,
            .usable_heap_size = 256860160,
            .heap_usage = 11579392,
            .max_allocation = 192645120,
         },
         .gtt = {
            .total_heap_size = 8359135232,
            .usable_heap_size = 8347318272,
            .heap_usage = 22102016,
            .max_allocation = 6260488704,
         },
      },
   },
   {
   ...
   },
   {
      ...
      .dev = {
         ...
         .num_shader_arrays_per_engine = 2,
         .gpu_counter_freq = 27000,
         .max_engine_clock = 1100000llu,
         .max_memory_clock = 1250000llu,
         .cu_active_number = 20,
         ...
         .pa_sc_tile_steering_override = 0,
         .tcc_disabled_mask = 0llu,
         .min_engine_clock = 300000llu,
         .min_memory_clock = 150000llu,
         .tcp_cache_size = 0,
         .num_sqc_per_wgp = 0,
         .sqc_data_cache_size = 0,
         .sqc_inst_cache_size = 0,
      ...
      .mem = {
         .vram = {
            ...
            .usable_heap_size = 2134118400,
            .heap_usage = 5238784,
            .max_allocation = 1600588800,
         },
         .cpu_accessible_vram = {
            .total_heap_size = 268435456,
            .usable_heap_size = 263458816,
            .heap_usage = 4976640,
            .max_allocation = 197594112,
         },
         .gtt = {
            .total_heap_size = 8363028480,
            .usable_heap_size = 8359759872,
            .heap_usage = 3530752,
            .max_allocation = 6269819904,
         },
      },
   },
   {
      ...
      .dev = {
         ...
         .num_shader_arrays_per_engine = 1,
         .gpu_counter_freq = 27000,
         .max_engine_clock = 1075000llu,
         .max_memory_clock = 1600000llu,
         .cu_active_number = 14,
         .cu_ao_mask = 0x7f007f,
         .cu_bitmap = {
            { 0x7f, 0x0, 0x0, 0x0, },
      ...
      .mem = {
         .vram = {
            .total_heap_size = 2147483648,
            .usable_heap_size = 2118266880,
            .heap_usage = 21352448,
            .max_allocation = 1588700160,
         },
         .cpu_accessible_vram = {
            .total_heap_size = 268435456,
            .usable_heap_size = 255901696,
            .heap_usage = 20828160,
            .max_allocation = 191926272,
         },
         .gtt = {
            .total_heap_size = 16746776576,
            .usable_heap_size = 16743417856,
            .heap_usage = 3883008,
            .max_allocation = 12557563392,
         },
      },
   }
};
